CREATE DATABASE `tp4` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
use `tp4`;

CREATE USER 'y'@'localhost' IDENTIFIED BY 'SJzEeqLb2HHeNYVV';
...
GRANT ALL PRIVILEGES ON `tp4` . * TO 'y'@'localhost';
-- 
-- --------------------------------------------------------
