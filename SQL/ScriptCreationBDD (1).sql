...
(
	...
	MISSON varchar(255) NOT NULL,
	CONTRAT varchar(255) NOT NULL,
	
	constraint FK_OFFRE_ENTREPRISE foreign key(ID_ENTREPRISE) references T_USER (ID_USER)
);
...
(
	...
	TEXTE varchar(1000),
	constraint PK_T_COMMENTAIRE primary key (ID_OFFRE, ID_USER),
	constraint FK_COMMENTAIRE_OFFRE foreign key(ID_OFFRE) references T_OFFRE (ID_OFFRE),
	constraint FK_COMMENTAIRE_USER foreign key(ID_USER) references T_USER (ID_USER)
);
...
(
	...
	constraint FK_LIKES_OFFRE foreign key(ID_OFFRE) references T_OFFRE (ID_OFFRE),
	constraint FK_LIKES_USER foreign key(ID_USER) references T_USER (ID_USER)
